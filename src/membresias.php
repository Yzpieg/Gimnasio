...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST['nueva_membresia'])) {
        ...
        $mensaje = agregarMembresia($conn, $tipo, $precio, $duracion, $beneficios);
        ...
        $duracion = intval($_POST['duracion']);
        $beneficios = trim($_POST['beneficios']);
        $mensaje = editarMembresia($conn, $id_membresia, $tipo, $precio, $duracion, $beneficios);
...
// Obtener todas las membresías para mostrar en la página
$membresias = [];
                ...
                <li>
                    <form method="POST" action="membresias.php" class="membresia-item">
                        ...
                        <div class="membresia-botones">
                            ...
                            <button type="submit" name="eliminar_membresia" onclick="return confirm('¿Estás seguro de que deseas eliminar esta membresía?')">Eliminar</button>
                        </div>
                    </form>
                </li>
            <?php endforeach; ?>
